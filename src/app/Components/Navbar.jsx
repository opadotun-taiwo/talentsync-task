  ...
  return (
    <div className='flex items-center justify-between my-5 mx-[16px] p-4 bg-[#D0D5DD] rounded-[100px] border border-[#D0D5DD]'>
      ...
      <div className='flex justify-center items-center gap-[40px] text-[#667085] text-[18px]'>
        <p className='flex justify-center items-center gap-2'>Products<span><Image src='/icon_.png' width={10} height={10}/></span></p>
        <p className='flex justify-center items-center gap-2'>Solutions<span><Image src='/icon_.png' width={10} height={10}/></span></p>
        <p className='flex justify-center items-center gap-2'>Resources<span><Image src='/icon_.png' width={10} height={10}/></span></p>
        <p className='flex justify-center items-center gap-2'>Price<span><Image src='/icon_.png' width={10} height={10}/></span></p>
      </div>
      <div>
